...

{
  ...
  xdg.configFile."../.vieb/colors/theme.css" = {
    text = ''
:root {
    /* general */
    --bg: #${config.lib.stylix.colors.base00};
    --fg: #${config.lib.stylix.colors.base05};
    --tab-background: #${config.lib.stylix.colors.base01};
    --tab-suspended: #${config.lib.stylix.colors.base00};
    --visible-tab: #${config.lib.stylix.colors.base03};
    --tab-split: #${config.lib.stylix.colors.base09};
    --tab-audio: #${config.lib.stylix.colors.base0B};
    --tab-muted: #${config.lib.stylix.colors.base05};
    --tab-muted-playing: #${config.lib.stylix.colors.base09};
    --tab-crashed: #${config.lib.stylix.colors.base08};
    --tab-unresponsive: var(--tab-crashed);
    --tab-scrollbar: #${config.lib.stylix.colors.base0C};
    --container-background: none;
    --mode-normal-fg: #eee;
    --mode-normal-bg: none;
    --mode-command-fg: #${config.lib.stylix.colors.base08};
    --mode-command-bg: none;
    --mode-insert-fg: #3f3;
    --mode-insert-bg: none;
    --mode-follow-fg: #${config.lib.stylix.colors.base08};
    --mode-follow-bg: none;
    --mode-explore-fg: #${config.lib.stylix.colors.base0C};
    --mode-explore-bg: none;
    --mode-search-fg: #${config.lib.stylix.colors.base09};
    --mode-search-bg: none;
    --mode-pointer-fg: #${config.lib.stylix.colors.base03};
    --mode-pointer-bg: #${config.lib.stylix.colors.base05};
    --mode-visual-fg: #${config.lib.stylix.colors.base00};
    --mode-visual-bg: #${config.lib.stylix.colors.base0B};
    --url-default: #${config.lib.stylix.colors.base04};
    --url-search: #${config.lib.stylix.colors.base09};
    --url-searchwords: #${config.lib.stylix.colors.base0D};
    --url-url: #${config.lib.stylix.colors.base0C};
    --url-suggest: #3f3;
    --url-file: #${config.lib.stylix.colors.base09};
    --url-invalid: #${config.lib.stylix.colors.base08};
    --follow-text: #21202e;
    --follow-url-bg: #${config.lib.stylix.colors.base0C};
    --follow-url-border: #${config.lib.stylix.colors.base0B};
    --follow-url-hover: #7dd7;
    --follow-click-bg: #${config.lib.stylix.colors.base0A};
    --follow-click-border: #${config.lib.stylix.colors.base08};
    --follow-click-hover: #d777;
    --follow-insert-bg: #${config.lib.stylix.colors.base0C};
    --follow-insert-border: #${config.lib.stylix.colors.base0B};
    --follow-insert-hover: #7d77;
    --follow-onclick-bg: #${config.lib.stylix.colors.base0A};
    --follow-onclick-border: #${config.lib.stylix.colors.base09};
    --follow-onclick-hover: #dd77;
    --follow-media-bg: #bbf;
    --follow-media-border: #77d;
    --follow-media-hover: #77d7;
    --follow-image-bg: #${config.lib.stylix.colors.base0D};
    --follow-image-border: #d7d;
    --follow-image-hover: #d7d7;
    --follow-other-bg: #${config.lib.stylix.colors.base05};
    --follow-other-border: #${config.lib.stylix.colors.base04};
    --follow-other-hover: #bbb7;
    --suggestions-border: #${config.lib.stylix.colors.base00};
    --suggestions-bg: #${config.lib.stylix.colors.base00};
    --suggestions-selected: #${config.lib.stylix.colors.base04};
    --suggestions-searchwords: #${config.lib.stylix.colors.base0D};
    --suggestions-url: #${config.lib.stylix.colors.base0C};
    --suggestions-file: #ffb;
    --notification-border: #21202e;
    --notification-date: #${config.lib.stylix.colors.base04};
    --notification-permission: #${config.lib.stylix.colors.base04};
    ...
    --notification-info: #${config.lib.stylix.colors.base0B};
    --notification-success: #3f3;
    --url-hover-fg: #${config.lib.stylix.colors.base00};
    --url-hover-bg: #fff9;
    --screenshot-highlight: #${config.lib.stylix.colors.base09};
    --screenshot-highlight-background: #f907;
    /* special pages */
    --link-color: #${config.lib.stylix.colors.base0B};
    --link-underline: #${config.lib.stylix.colors.base0B};
    --scrollbar-bg: #${config.lib.stylix.colors.base03};
    --scrollbar-thumb: #bbb9;
    --button-disabled: #${config.lib.stylix.colors.base04};
    --code-fg: #${config.lib.stylix.colors.base05};
    --code-bg: #21202e;
    --code-command: #${config.lib.stylix.colors.base08};
    --placeholder-text: #${config.lib.stylix.colors.base05};
    --special-page-element-bg: #${config.lib.stylix.colors.base03};
    --special-page-element-border: #${config.lib.stylix.colors.base01};
    --input-unfocused: #${config.lib.stylix.colors.base04};
    --input-focused: #${config.lib.stylix.colors.base04};
    --download-progress-fg: #${config.lib.stylix.colors.base05};
    --download-progress-bg: #${config.lib.stylix.colors.base04};
    --helppage-h1: #${config.lib.stylix.colors.base08};
    --helppage-h2: #f76;
    --helppage-h3: #fb9;
    --helppage-countable: #${config.lib.stylix.colors.base09};
    --helppage-range-compat: #${config.lib.stylix.colors.base09};
    --helppage-nativetheme-fg-light: #${config.lib.stylix.colors.base04};
    --helppage-nativetheme-bg-light: #${config.lib.stylix.colors.base05};
    --helppage-nativetheme-fg-dark: #${config.lib.stylix.colors.base04};
    --helppage-nativetheme-bg-dark: #${config.lib.stylix.colors.base00};
    --history-current-page-highlight: var(--helppage-h1);
    /* sourceviewer */
    --syntax-fg: var(--fg);
    --syntax-bg: var(--bg);
    --syntax-keyword: #${config.lib.stylix.colors.base08};
    --syntax-entity: #${config.lib.stylix.colors.base0D};
    --syntax-constant: #${config.lib.stylix.colors.base0C};
    --syntax-string: #${config.lib.stylix.colors.base0C};
    --syntax-variable: #${config.lib.stylix.colors.base09};
    --syntax-comment: #89a;
    --syntax-entity-tag: #8e8;
    --syntax-markup-heading: #${config.lib.stylix.colors.base0B};
    --syntax-markup-list: #${config.lib.stylix.colors.base09};
    --syntax-markup-emphasis: #${config.lib.stylix.colors.base0C};
